...
import websitelogo1 from '@/assets/websitelogo1.png'
    ...
    return (
        <div className={styles.leftSection}>
            <div className={styles.newChat}>
                <div>
                    <Image src={websitelogo} alt="AI Doctor" width={50} height={50} />
                    <p className={styles.text1}>Medication Recommendation</p>
            ...
            <div className={styles.newChat}>
                <div>
                    <Image src={websitelogo1} alt="AI Doctor" width={50} height={50} />
                    <p className={styles.text1}>yeabtsega20@gmail.com</p>
                </div>
